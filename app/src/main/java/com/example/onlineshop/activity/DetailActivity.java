...
import com.example.onlineshop.fragment.DescriptionFragment;
import com.example.onlineshop.fragment.ReviewFragment;
import com.example.onlineshop.fragment.SoldFragment;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void initBanners() {
        ...
        for (int i = 0; i < object.getPicUrl().size(); i++) {
            sliderItem.add(new SliderItem(object.getPicUrl().get(i)));
        }
        binding.viewpagerSlider.setAdapter(new SliderAdapter(sliderItem, binding.viewpagerSlider));
