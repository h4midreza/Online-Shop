...
import com.example.onlineshop.databinding.ViewholderPopularListBinding;
...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.viewHolder> {
    ...
    public PopularAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ViewholderPopularListBinding binding = ViewholderPopularListBinding.inflate(LayoutInflater.from(context), parent, false);
